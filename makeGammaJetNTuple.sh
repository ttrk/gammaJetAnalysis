...
# done
# hadd "gammaJets_pp_MC_PUallQCDPhoton.root" gammaJets_pp_MC_PUallQCDPhoton*.root
# echo "done pp MC"
...
#     ./makeGammaJetNTuple.exe "$INFILE" 3 "$OUTFILE" ${MCWEIGHT[COUNTER]}
# done
# hadd "gammaJets_pp_MC_EmEnrichedDijet.root" gammaJets_pp_MC_EmEnrichedDijet*.root
# echo "done pp MC"
...
# done
# hadd "gammaJets_pA_Data.root" pA_promptRECO/*.root
# echo "Done pA data"
