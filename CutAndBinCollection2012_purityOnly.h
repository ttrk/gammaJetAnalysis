...
fitResult doFit(TCanvas* c1, TH1D* hSig=0, TH1D* hBkg=0, TH1D* hData1=0, float varLow=0.001, float varHigh=0.028, bool drawLeg=true) {
  c1->Divide(1,2);
  c1->cd(1);
  ...
  f->SetParLimits(1,0,1);
   ...
   c1->cd(2);
   TH1D* hRatio = (TH1D*)hData1->Clone("hratio");
   hRatio->Divide(hSigPdf);
