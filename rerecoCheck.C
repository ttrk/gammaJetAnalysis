...
void rerecoCheck()
{
  ...
  rereco->Add("/mnt/hadoop/cms/store/user/pkurt/Hydjet1p8_TuneDrum_Quenched_MinBias_2760GeV/HydjetDrum_Pyquen_Dijet80_Embedded_FOREST_d20140129_STARTHI53_LV1_Track7_Jet1/24a2e0fade4e94e7a0ccf306522bdceb/*.root");
