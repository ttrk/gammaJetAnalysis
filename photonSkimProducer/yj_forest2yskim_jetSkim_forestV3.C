  ...
  )
{
  ...
  // L2L3 correction
  TFile* fL2L3pp = new TFile("../corrL2L3/Casym_pp_double_hcalbins_algo_ak3PF_pt100_140_jet80_alphahigh_20_phicut250.root"); TH1D * c_etapp=(TH1D*)fL2L3pp->Get("C_asym");
  ...
  */
  ...
  float l2l3corr[MAXJET];
  float PUcorr[MAXJET];
  float ptB4corr[MAXJET];
  ...
  newtreeJet->Branch("l2l3corr",l2l3corr,"l2l3corr[nJet]/F");
  newtreeJet->Branch("PUcorr",PUcorr,"PUcorr[nJet]/F");
  newtreeJet->Branch("ptB4corr",ptB4corr,"ptB4corr[nJet]/F");
  if ( isMC )  {
...
//	  continue;
   ...
   for (int j=0;j< c->photon.nPhotons;j++) {
	...
	l2l3corr[nJet]=l2l3Corr;
	PUcorr[nJet]=resCorrection;
