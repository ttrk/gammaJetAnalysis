...
void gammaJetHistProducer_ak5(sampleType collision = kPADATA, float photonPtThr=60, float photonPtThrUp=9999, float jetPtThr=30, int icent =1) {
  TH1::SetDefaultSumw2();
  ...
  else if ( collision == kPADATA) fname = fnamePADATA_Cone05;
  else if ( collision == kPPDATA) {
    if ( icent == 7 ) fname = fnamePPDATA_Cone05;
    else fname = "";
  }  
  else fname = "";
  ...
  if (  ( collision == kHIDATA)   || ( collision==kPADATA) || ( collision == kPPDATA) ) {
    ...
    tgj->addFile(fnamePPMC_AllQcdPho30to50_Cone05,    "tgj", evtSeltCut, wPPMC_AllQcdPho30to50);
    tgj->addFile(fnamePPMC_AllQcdPho50to80_Cone05,    "tgj", evtSeltCut, wPPMC_AllQcdPho50to80);
    tgj->addFile(fnamePPMC_AllQcdPho80to120_Cone05,   "tgj", evtSeltCut, wPPMC_AllQcdPho80to120);
    tgj->addFile(fnamePPMC_AllQcdPho120to9999_Cone05, "tgj", evtSeltCut, wPPMC_AllQcdPho120to9999);
  }
  else if ( collision == kPAMC ) {
    tgj->addFile(fnamePAMC_AllQcdPho30to50_Cone05,    "tgj", evtSeltCut, wPAMC_AllQcdPho30to50);
    tgj->addFile(fnamePAMC_AllQcdPho50to80_Cone05,    "tgj", evtSeltCut, wPAMC_AllQcdPho50to80);
    tgj->addFile(fnamePAMC_AllQcdPho80to120_Cone05,   "tgj", evtSeltCut, wPAMC_AllQcdPho80to120);
    tgj->addFile(fnamePAMC_AllQcdPho120to9999_Cone05, "tgj", evtSeltCut, wPAMC_AllQcdPho120to9999);
  }
  else  {    // kHIMC
