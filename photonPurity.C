...
void photonPurity()
{
  ...
  const TCut sidebandIsolation = "((cc4+cr4+ct4PtCut20)/0.9>10) && ((cc4+cr4+ct4PtCut20)/0.9<20) && hadronicOverEm<0.1";
  //const TCut sidebandIsolation = "((cc4+cr4+ct4PtCut20)/0.9>5) && ((cc4+cr4+ct4PtCut20)/0.9<10) && hadronicOverEm<0.1";
