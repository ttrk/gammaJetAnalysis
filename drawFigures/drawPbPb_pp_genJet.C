...
void drawPbPb_pp_genJet( bool saveFigures=true) {
	...
	TString sampleName = getSampleName( icoll ) ;
            char* fname =  Form("ffFilesGenJet/photonTrackCorr_%s_output_photonPtThr%d_to_%d_jetPtThr30_20130916.root",sampleName.Data(), (int)ptBin[ipt-1], (int)ptBin[ipt]);
