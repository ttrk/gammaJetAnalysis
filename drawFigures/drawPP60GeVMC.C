...
void drawPP60GeVMC(TString dirName="nominal", int prodDate=20131021) {
  TH1::SetDefaultSumw2();
  TH1D* hxjg;
  TH1D* hDphi;
  ...
  char* fname =  Form("ffFiles/%s/photonTrackCorr_ppMC_output_photonPtThr60_to_9999_jetPtThr30_%d.root", dirName.Data(), prodDate);
