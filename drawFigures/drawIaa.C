...
void drawIaa( bool saveFigures=true) {
	...
	//	char* fname =  Form("ffFiles/photonTrackCorr_%s_output_photonPtThr%d_to_%d_jetPtThr30_20130923.root",sampleName.Data(), (int)ptBin[ipt-1], (int)ptBin[ipt]);
	char* fname =  Form("ffFiles/photonTrackCorr_%s_output_photonPtThr%d_to_%d_jetPtThr30_20130923.root",sampleName.Data(), (int)ptBin[ipt-1], 9999);
	...
	hTempPt->SetAxisRange(0.001,0.08,"Y");
